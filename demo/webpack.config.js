...
const StylePlugin = require('../dist/');
...
module.exports = {
  ...
  plugins: [
    new StylePlugin('./demo/src/page.sass', 'development', { sass: { sourceMapEmbed: false } }),
    new StylePlugin({ './demo/src/loading.scss': 'components/loader.css' }, 'production', { sass: { includePaths: [path.resolve(__dirname, '..', 'node_modules')] } }),
    new HtmlPlugin({
      // Required
      inject: false,
